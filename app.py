...
# Ruta al geojson. Debe ser RELATIVA a app.py para que funcione igual en
# Colab, tu PC y en Streamlit Community Cloud. Sube el archivo a una carpeta
# "data/" dentro de tu repo de GitHub, junto a app.py.
GEOJSON_PATH = "data/lima_callao_distritos_simple.geojson"
